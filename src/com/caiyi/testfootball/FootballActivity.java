	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		st.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int arg0) {
				...
				try {
					mTabActionbar.setCanHideOnScroll(ListViewHelper.getScrollRange(lv) - lv.getHeight()
							- lv.getPaddingTop());
					mTabActionbar.onPageChanged(ListViewHelper.getScrollY(lv));
